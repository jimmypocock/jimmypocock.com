...
export const metadata: Metadata = {
  ...
  title: {
    default: "Jimmy Pocock - Developer, Musician, Writer",
    template: "%s | Jimmy Pocock"
  },
  description: "Jimmy Pocock is a full-stack developer, electronic music producer, and creative writer based in Austin, Texas. Exploring the intersection of technology, art, and human experience.",
  keywords: [
    "jimmy pocock",
    "jimmy pocock austin",
  ...
  openGraph: {
    title: "Jimmy Pocock - Developer, Musician, Writer",
    description: "Full-stack developer, electronic music producer, and creative writer exploring the intersection of technology and creativity.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Jimmy Pocock - Developer, Musician, Writer",
      }
    ],
  },
  twitter: {
