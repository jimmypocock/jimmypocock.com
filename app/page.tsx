...
export default function Home() {
  const professionalItems: LinkItem[] = [
    ...
    { prefix: 'i built', text: 'roverpass', href: 'https://www.roverpass.com/' },
    { prefix: 'i built', text: 'vocal technique translator', href: 'https://www.vocaltechniquetranslator.com/' },
    { prefix: 'i built', text: 'songsnips', href: 'https://www.songsnips.com/' },
    { prefix: 'i built', text: 'aws cost delta monitor', href: 'https://github.com/jimmypocock/AWSDeltaCostUsage' },
  ];
